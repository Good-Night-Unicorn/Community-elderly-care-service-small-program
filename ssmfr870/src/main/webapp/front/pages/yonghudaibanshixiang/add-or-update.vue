	...
	export default {
		...
		async onLoad(options) {
			...
			if (options.id) {
				...
				// 获取信息
				res = await this.$api.info(`yonghudaibanshixiang`, this.ruleForm.id);
		...
		methods: {
			...
			async onSubmitTap() {
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																if(this.ruleForm.id){
					await this.$api.update(`yonghudaibanshixiang`, this.ruleForm);
				}else{
					await this.$api.add(`yonghudaibanshixiang`, this.ruleForm);
				}
